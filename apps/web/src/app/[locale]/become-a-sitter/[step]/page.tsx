      ...
      {step === 'home' && (
        <HomeForm
          ...
          initial={{
            ...
            spayedNeuteredOnly: state.spayedNeuteredOnly,
            noFemalesInHeat: state.noFemalesInHeat,
            houseTrainedOnly: state.houseTrainedOnly,
            minPetAgeMonths: state.minPetAgeMonths,
