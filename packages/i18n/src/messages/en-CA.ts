export const enCA = {
  ...
  */
  ...
  calendar: {
    ...
    publicLead: 'Open days are the days {name} can take a booking. Dates are confirmed when they accept your request.',
    publicAsOf: 'Read from the calendar on {date}.',
  ...
  */
  ...
  auth: {
    ...
    magicLinkSpam: 'Nothing after a minute? Check your spam folder — the message comes from our address, not a person.',
    magicLinkDevice: 'Open the link on this device if you can; it signs you in right here.',
    magicLinkResend: 'Send it again',
    magicLinkResent: 'Sent again — the older link no longer works.',
    magicLinkWait: 'You can ask again in {seconds} s',
    magicLinkOther: 'Use a different address',
  ...
  onboarding: {
    ...
    'intro.home': 'This is the part owners ask about first: where their animal will sleep, and what a day with you looks like.',
    ...
    'services.sizes': 'Pet sizes you can take',
    'services.sizesHint': 'Tick every size you are happy with — you can skip one in the middle. An owner searching with a pet outside these sizes will not see this service.',
    'services.size.small': 'Small',
    'services.size.medium': 'Medium',
    'services.size.large': 'Large',
    'services.size.giant': 'Giant',
    'services.sizeRange.small': 'up to {max} kg',
    'services.sizeRange.medium': '{min}–{max} kg',
    'services.sizeRange.large': '{min}–{max} kg',
    'services.sizeRange.giant': '{min} kg and up',
    ...
    'home.groupPlace': 'Your place',
    'home.groupRules': 'House rules',
    'home.groupRulesLead': 'Optional. Leave a question blank and we say nothing about it \u2014 better than guessing on your behalf.',
    'home.groupPets': 'Which pets you can take',
    'home.groupPetsLead': 'Optional. Tick only what is true for you — an unticked box says nothing on your profile.',
    'home.spayedOnly': 'Spayed and neutered pets only',
    'home.noHeat': 'No females in heat',
    'home.houseTrained': 'House-trained pets only',
    'home.minAge': 'Youngest pet you take (months)',
    'home.minAgeHint': 'Leave blank if you take any age. 12 means one year and up.',
    'home.groupWords': 'In your own words',
    'home.groupWordsLead': 'Optional, and shown on your profile as your words, not as something Havre checked.',
    'home.yes': 'Yes',
    'home.no': 'No',
    'home.unanswered': 'Rather not say',
    'home.hasChildren': 'Children at home',
    'home.hasChildrenHint': 'Some dogs are nervous around children. Owners would rather know now.',
    'home.petsOnBed': 'Pets allowed on the bed',
    'home.petsOnFurniture': 'Pets allowed on furniture',
    'home.pottyBreak': 'Potty breaks, every (hours)',
    'home.pottyBreakHint': 'How often a dog staying with you gets outside. Leave blank if it depends.',
    'home.schedule': 'My schedule',
    'home.scheduleHint': 'When you are home, when you work, how much of the day a pet is with someone.',
    'home.typicalDay': 'A day with me',
    'home.typicalDayHint': 'Walks, meals, where the pet sleeps \u2014 the ordinary shape of the day.',
    'home.safety': 'Safety and emergencies',
    'home.safetyHint': 'Fencing, a crate, your vet, what you do if something goes wrong.',
    'home.ownerPrefs': 'What I would like to know about your pet',
    'home.ownerPrefsHint': 'Write it once here and owners can answer it before they message you.',
    ...
    'review.petCountOne': 'one pet at a time',
    ...
    'error.postalProvinceMismatch': 'This postal code is in a different province than the city you picked. Check both — the first letter of a postal code decides the province.',
  ...
  sitterLanding: {
    ...
    'start.heading': 'Love animals? Get paid properly for it.',
    'start.body': 'Two ways in, depending on where you are starting from.',
    'start.newTitle': 'I am new to this',
    'start.newBody': 'What the work involves, what it asks of you, and what it pays.',
    'start.newCta': 'Read what sitting involves',
    'start.clientsTitle': 'I already have clients',
    'start.clientsBody': 'Bring them with you. We take 0% on their bookings, permanently.',
    'start.clientsCta': 'See the three rates',
    workHeading: 'What sitting actually involves',
    workNote: 'Written out before you spend fifteen minutes on an application.',
    'work.doTitle': 'What you actually do',
    'work.doBody': 'Four services: a pet stays overnight at your home, you stay at theirs, you drop in to feed and change a litter tray, or you take a dog out for a walk. You choose which ones you offer \u2014 offering only one is normal.',
    'work.timeTitle': 'What it asks of your time',
    'work.timeBody': 'You keep your own calendar and a day is blocked the moment you accept it. Boarding and house sitting take a whole day; drop-in visits and walks are half an hour to an hour.',
    'work.needTitle': 'What you need first',
    'work.needBody': 'To be 18 or older, an enhanced criminal record check and identity verification, a Canadian bank account, and a Social Insurance Number for CRA reporting. If you offer boarding, your home is part of what owners see.',
    'work.payTitle': 'What it pays',
    'work.payCity': 'You set your own price. In {city} the median boarding rate is {price} a night \u2014 what sitters here actually charge, not a promise about what you will earn. We take {pct}% of it, and nothing at all on clients you bring yourself.',
    'work.payPlain': 'You set your own price; we do not set it for you and we do not cap it. We take {pct}% of what you charge, and nothing at all on clients you bring yourself.',
  ...
  sitter: {
    ...
    'stat.responseRate': 'answered',
    ratingBreakdown: 'How the ratings split',
    ratingRow: '{stars} stars: {count}',
    ...
    /* "1 pets" yaziyordu. Tekil kendi anahtarinda: sayiyi cumleden
       cikarip yerine koymak Fransizca'da da bozuluyor. */
    'home.maxPetsOne': 'Takes one pet at a time',
    petsHeading: 'Pets {name} can take',
    'pets.sizeNote': 'Sizes are what {name} accepts across their services.',
    'pets.spayedOnly': 'Spayed and neutered pets only',
    'pets.noHeat': 'No females in heat',
    'pets.houseTrained': 'House-trained pets only',
    /* Tekil ve cogul AYRI anahtar: "2 year old and up" Ingilizce'de,
       "1 ans et plus" Fransizca'da yanlis. */
    'pets.minAgeYear': 'One year old and up',
    'pets.minAgeYears': '{years} years old and up',
    'pets.minAgeMonths': '{months} months old and up',
    'pets.sizeSmall': 'Up to {max} kg',
    'pets.sizeBand': '{min}–{max} kg',
    'pets.sizeGiant': 'Over {min} kg',
    'pets.noSizes': '{name} has not said which sizes they take yet.',
    'home.children': 'Children live here',
    'home.noChildren': 'No children in the home',
    'home.petsOnBed': 'Pets may sleep on the bed',
    'home.petsOffBed': 'Pets do not sleep on the bed',
    'home.petsOnFurniture': 'Pets may get on the furniture',
    'home.petsOffFurniture': 'Pets stay off the furniture',
    'home.pottyBreak': 'Potty break about every {hours} hours',
    /*
      BAKICININ KENDI CUMLELERI. Basliklar sahibin sordugu SORULAR,
      bizim alan adlarimiz degil. Not satiri her blokta degil bir kez:
      tekrar edilen bir uyari okunmuyor.
    */
    routineHeading: 'Day to day with {name}',
    scheduleHeading: 'Their schedule',
    typicalDayHeading: 'A day with {name}',
    safetyHeading: 'Safety and emergencies',
