export const enCA = {
  ...
  */
  ...
  onboarding: {
    ...
    'services.maxSize': 'Biggest pet you can take',
    'services.maxSizeHint': 'Owners searching with a heavier pet will not see this service.',
    'services.size.small': 'Up to {max} kg',
    'services.size.medium': 'Up to {max} kg',
    'services.size.large': 'Up to {max} kg',
    'services.size.giant': 'Any size',
